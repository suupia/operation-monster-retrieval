...
public static class Function
{
    ...
    public static List<Vector2Int> NonDiagonalSearchShortestRoute(Vector2Int startPos, Vector2Int endPos)  //startPosからendPosへの斜め移動なしの最短経路を返す（startPos、endPosどちらも含む）
    {
        //数字を配置する時に上下にだけおいていく
    ...
    public static List<Vector2Int> DiagonalSearchShortestRoute(Vector2Int startPos, Vector2Int endPos)  //startPosからendPosへの斜め移動蟻の最短経路を返す（startPos、endPosどちらも含む）
    {
        //数字を置くとき周り8マスに置いていく
        int width = GameManager.instance.mapMGR.GetMapWidth();
        int height = GameManager.instance.mapMGR.GetMapHeight();
    ...
    public static List<Vector2Int> SearchShortestNonDiagonalRouteToCastle(Vector2Int startPos)
    {
        ...
        return NonDiagonalSearchShortestRoute(startPos, endPos);
    }
    public static List<Vector2Int> SearchShortestDiagonalRouteToCastle(Vector2Int startPos)
    {
        Vector2Int castlePos = GameManager.instance.mapMGR.GetEnemysCastlePos();
        Vector2Int endPos = Vector2Int.zero;
        ...
        return DiagonalSearchShortestRoute(startPos, endPos);
    }
