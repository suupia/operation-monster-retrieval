...
{
    private int numOfSkills = 4; //Skillの種類数
    private float durationOfSkill_0 = 3;
    //private float durationOfSkill_1 = 3;
    private float durationOfSkill_2 = 5;
    private float raiseOfSPD = 1;
    private int raiseOfAtk = 20;
    private int raiseOfTime = 1;
    ...
    private IEnumerator Skill_2(CharacterMGR characterMGRInstace) //ATKをあげる
    {
        ...
        characterMGRInstace.SetAtk(characterMGRInstace.GetAtk() + raiseOfAtk);
